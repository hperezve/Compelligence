...
<div class="responseTextReply"><%=ViewData["ResponseText"] %>  </div>
<% using (Html.BeginForm("DiscussionsResponseSave", "Forum", FormMethod.Post, 
     new { id = "DiscussionsResponseForm", ENCTYPE = "multipart/form-data" }))
  { %>
