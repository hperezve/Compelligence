            	...
            	<div Id="Header">
					...
					************************-->					
					<div id="LoginForm">
                      ...
                      {%>
					  <div id="ShowLogin">
                        <% using (Html.BeginForm("LoginToApprovedEmail", "Home", FormMethod.Post, new { id = "form-top" }))
                           { %>      
                           <%= Html.Hidden("IndexNewUser", ViewData["NewUserId"].ToString())%>							      
                           <%= Html.Hidden("IndexUserApproved", ViewData["UserApprovedId"].ToString())%>  
                            <div>															
