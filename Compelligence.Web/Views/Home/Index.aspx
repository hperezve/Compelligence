...
<script type="text/javascript">
    ...
    var IsValidDns = '<%=(bool)ViewData["IsValidDns"]%>';
        ...
        var ShowRegisterUser = '<%=(bool)ViewData["showRegisterUser"]%>';
        if (ShowRegisterUser == 'False') {
            $('#LoginCentre').css('width', '60%');
            $('#Register').css('height', '62px');
        }
            ...
            <div id="ContentIformation">
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        if ($("#Msg").html() != '') {
                            jAlert('This company instance has been disabled. Please contact support@&#99ompelligence.com for assistance.', 'Information message');
                        }
                    });
                 </script>
                 <div id="MsgTimeOut" style=" color:Black;display:none;"><%=Html.ViewData["messageTimeOut"]%></div>  
                <script type="text/javascript">
                    $(document).ready(function() {
                        if ($("#MsgTimeOut").html() != '') {
                            jAlert('You have been logged out of Compelligence due to inactivity.', 'Information message');
                        }
                    });
                 </script>
            	<div Id="Header">
					...
					<div id="LoginCentre">
                            ...
                            {%>
                               <% if ((bool)ViewData["ShowRegisterUser"])
                                  { %>
                              <div Id="RegisterUser">	
                               ...
                               <%}
                                  ...
                                  { %>
                                  <div class="companyDisabled">
                                  This company instance has been disabled. Please contact support@compelligence.com for assistance.
                                  </div>
                               <%} %>
                            <%} %>			    
					</div>
					...
					************************-->					
					<div id="LoginForm">
                      ...
                      {%>
					  <div id="ShowLogin">
                        <% using (Html.BeginForm("Login", "Home", FormMethod.Post, new { id = "form-top" }))
                           { %>      
                            <div>															
                      ...
                      <div class="forgotlinks">
                        <a id="forgotkennwort" style="font-color:#000;font-size:61%" class="Static" href="<%= Url.Action("ForgotKennwort", "Home") %>">Forgot Your Password?</a>
                      </div>
                      <div class="forgotlinks">
                        <a id="forgotusername" style="font-color:#000;font-size:61%" class="Static" href="<%= Url.Action("ForgotUserName", "Home") %>">Forgot Your User Name?</a>
                      </div>
                      </div>  
                      <%} %>
                    </div>
