    ...
    <script type="text/javascript">
        var returnValues = function() {
            ...
            if (existsWindowOpener) {
                ...
                var entityOption = '<%= ViewData["EntityOption"] %>';
                var scope = '<%= ViewData["Scope"] %>';
                var browseId = '<%= ViewData["BrowseId"] %>';
                var browseHierarchy = '<%= ViewData["BrowseHierarchy"] %>';
                var gridId = '#'+scope + browseName + 'ListTable';
                ...
                window.opener.loadSelectedPopupItemsPositioning(selectedItems, entityOption, scope, browseId, browseHierarchy);
            }
