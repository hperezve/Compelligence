...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="titleTextOne">
        Disable Company in Compelligence Systems</div>
    <div class="titleTextTwo">
        your Competitive Intelligence Systems!!</div>
    <div id="contentRegister">
        <%= Html.ValidationSummary()%>
        <% using (Html.BeginForm("DisableAccount", "MaintenanceAccount", FormMethod.Post, new { id = formId, align = "left" }))
           { %>
