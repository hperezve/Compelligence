    ...
    $.fn.cluetip = function(js, options) {
      ...
      .css({ position: 'absolute', display: 'none' });
        ...
        if (!$cluetipWait.length) {
            $cluetipWait = $('<div></div>').prop('id', 'cluetip-waitimage').css({ position: 'absolute' });
        }
        ...
        this.each(function(index) {
          ...
          isActive = false,
          closeOnDelay = 0,
          tipAttribute = opts[opts.attribute] || $link.attrProp(opts.attribute) || $link.prop(opts.attribute),
          ...
          ajaxMergedSettings;
                ...
                if (tipAttribute == $link.prop('href')) {
                ...
                var mouseTracks = function(evt) {
                    if (opts.tracking) {
                        ...
                        $link.bind('mousemove.cluetip', function(evt) {
                            $cluetip.css({ left: evt.pageX + trackX, top: evt.pageY + trackY + 20 });
                        });
                    }
                };
