...
(function($) {
    ...
    $.widget('ui.spinner', {
        ...
        _markupOptions: function() {
            ...
            $.each({
                ...
                if (_this.options[attr] === null) {
                    var value = _this.element.prop(attr);
        ...
        _uiSpinnerHtml: function() {
            return '<div role="spinbutton" class="ui-spinner ui-state-default ui-widget ui-widget-content "></div>';
        },
        ...
        _aria: function() {
            this.uiSpinner
			.prop('aria-valuemin', this.options.min)
			.prop('aria-valuemax', this.options.max)
			.prop('aria-valuenow', this.options.value);
        },
