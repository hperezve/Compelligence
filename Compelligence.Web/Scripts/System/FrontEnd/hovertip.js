...
hovertipTargetPrepare = function(o, el, config) 
{
  ...
  .hover(function() {
      ...
      {
          //             .wrap1.wrap2.wrap3
          var subhover=el.childNodes[0].childNodes[0].childNodes[0];
          var subdiv=subhover.firstChild.nextSibling.nextSibling.nextSibling; //hoverdiv
          if(subdiv.innerHTML.length > 0 )
          {
